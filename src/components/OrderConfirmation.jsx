...
const OrderConfirmation = ({cart}) => {
  ...
  return (
    <div className='bg-white rounded-[15px] py-6 px-4 absolute top-[4em] z-40 w-[100%] sm:w-[30%] sm:absolute sm:top-[15%] sm:left-[35%]'>
          ...
          <div className='p-5 bg-[#FFFAF0] rounded-[15px]'>
            ...
            <div className='flex justify-between'>
              ...
              <h1 className='text-xl font-bold'>${getTotal(cart)}</h1>
            </div>
          </div>
